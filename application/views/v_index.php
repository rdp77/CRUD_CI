...
<body class="body">
  <div class="card text-center">
    ...
    <div class="card-body">
      ...
      <div class="yuhu">
        <a href="<?php echo site_url('daftar'); ?>" class="btn btn-primary btn-block"><i class="fas fa-user-plus"> Daftar</i></a>
        <a href="<?php echo site_url('cek'); ?>" class="btn btn-primary btn-block"><i class="fas fa-user-cog"> Cek</i></a>
      </div>
    </div>
